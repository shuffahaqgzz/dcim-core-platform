...
| 6 | Asset and CMDB context | Stable Asset/CI identity, aliases, validity/confidence, collision handling, persistence and APIs | identity/collision/alias tests; migration/rollback evidence; implement against the OD-01 custom PostgreSQL CMDB baseline accepted 2026-07-28 |
