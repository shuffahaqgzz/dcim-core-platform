...
| R-CR-03 | Open decisions OD-01 (CMDB) dan OD-07 (language/framework) memblokir semua service development | 5 | 4 | 20 | `docs/governance/OPEN-DECISIONS.md`, `services/*/README.md` placeholder | Product Owner/Architect | Lock decisions dalam 1 minggu; update ADRs; communicate to team | Open |
| R-CR-04 | Phase 1 foundation tidak stabil sehingga Phase 2 tidak pernah dimulai dengan scope jelas | 5 | 4 | 20 | Issue #20, #21 open; PR #22 open; 63 commit in 1 day in unstable branch | Tech Lead | Tutup PR #22 dengan scope minimal; freeze Phase 2 to P1 server health slice; archive/rebase backup branches | Open |
